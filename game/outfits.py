...
OUTFITS = [
    ...
    {"id": "guarda_alvorada", "nome": "Guarda da Alvorada", "lvl": 1,
     "cloak": "#3a4a6a", "accent": "#c9a842", "npc_only": True,
     "desc": "A armadura azul-e-aço da legião que guarda Prospera."},
    {"id": "oficial_alvorada", "nome": "Oficial da Alvorada", "lvl": 1,
     "cloak": "#2a3a5a", "accent": "#e8c860", "npc_only": True,
     "desc": "O manto de comando: o sol nascente bordado no ombro."},
    {"id": "guarda_real", "nome": "Guarda Real Dourada", "lvl": 1,
     "cloak": "#c9a842", "accent": "#fff0c0", "npc_only": True,
     "desc": "Ouro da cabeça aos pés. Só protege a coroa."},
