...
ITEMS = {
    ...
    "garra_krezath":       {"name": "Garra de Krezath",     "kind": "trofeu", "stackable": True, "color": "#8a2020", "value": 900, "desc": "Uma garra do Devorador Soterrado, ainda morna mil anos depois. Colecionadores matariam por ela. Você só precisou matar um dragão."},
