...
ITEMS = {
    ...
    # ===== AS FRUTAS DOS DEUSES (só na banca da Zélia, Cidade Alta) =====
    "caju_do_sol":    {"name": "Caju-do-Sol",     "kind": "consumivel", "stackable": True, "color": "#f2a04e", "visual": "fruit", "rarity": "raro", "heal": 30, "value": 45, "desc": "Fruta abençoada por Valíria: amadurece virada pra aurora. Restaura 30 de vida e esquenta o peito. A Zélia jura que colhe cantando."},
    "ameixa_da_lua":  {"name": "Amêixa-da-Lua",   "kind": "consumivel", "stackable": True, "color": "#8a7ae0", "visual": "fruit", "rarity": "raro", "heal": 24, "value": 40, "desc": "Só amadurece em noite de lua cheia, dizem que Nherith sonha dentro dela. Restaura 24 de vida e dá um sono bom depois."},
    "uva_do_tempo":   {"name": "Uva-do-Tempo",    "kind": "consumivel", "stackable": True, "color": "#7ac06a", "visual": "fruit", "rarity": "raro", "heal": 18, "value": 30, "desc": "Cada bago leva exatamente um ano pra ficar pronto: Martur não tem pressa. Restaura 18 de vida, devagar e sempre."},
    "pessego_da_sorte": {"name": "Pêssego-da-Sorte", "kind": "consumivel", "stackable": True, "color": "#e08ae0", "visual": "fruit", "rarity": "raro", "heal": 26, "value": 42, "desc": "Nharé mordeu um uma vez e deixou a sorte no caroço. Restaura 26 de vida. O caroço, guarde: nunca se sabe."},
    "figo_do_punho":  {"name": "Figo-do-Punho",   "kind": "consumivel", "stackable": True, "color": "#a83838", "visual": "fruit", "rarity": "raro", "heal": 28, "value": 44, "desc": "Cresce apertado, cai brigando. Korgath aprova. Restaura 28 de vida e dá vontade de socar uma rocha (não soque)."},
    "roma_do_corvo":  {"name": "Romã-do-Corvo",   "kind": "consumivel", "stackable": True, "color": "#5a5a6a", "visual": "fruit", "rarity": "raro", "heal": 22, "value": 38, "desc": "Cada semente é uma fofoca de outro mundo, diz a Zélia. Restaura 22 de vida e deixa o ouvido esperto."},
    # ===== OS ELIXIRES DA ALVORADA (receitas do discípulo Elian, dificílimas) =====
    "elixir_alvorada": {"name": "Elixir da Alvorada", "kind": "consumivel", "stackable": True, "color": "#e8c860", "visual": "potion", "rarity": "epico", "buff": "dano", "buff_secs": 1200, "value": 900, "desc": "O sol engarrafado do Conclave: por 20 minutos, TODOS os seus golpes causam 15%% a mais de dano. Difícil de fazer, impossível de esquecer."},
    "casca_de_pedra":  {"name": "Casca de Pedra",  "kind": "consumivel", "stackable": True, "color": "#8a8a7a", "visual": "potion", "rarity": "epico", "buff": "pedra", "buff_secs": 1200, "value": 850, "desc": "A paciência de Martur em forma líquida: por 20 minutos sua pele endurece (+6 de armadura). Gosto de cascalho, efeito de muralha."},
    "sangue_de_fenix": {"name": "Sangue de Fênix", "kind": "consumivel", "stackable": True, "color": "#e05a4e", "visual": "potion", "rarity": "epico", "buff": "regen", "buff_secs": 900, "value": 950, "desc": "Por 15 minutos, sua vida se recompõe sozinha, gota a gota, como brasa que não aceita apagar."},
    "nevoa_de_nhare":  {"name": "Névoa de Nharé",  "kind": "consumivel", "stackable": True, "color": "#c9c4d4", "visual": "potion", "rarity": "epico", "buff": "nevoa", "buff_secs": 1200, "value": 900, "desc": "Por 20 minutos, um em cada dez golpes inimigos passa por onde você NÃO está. A Lebre pisca pra você."},
    # ===== ALTA COSTURA: materiais e o SET DE OPULÊNCIA PROSPERIANA =====
    "tecido_prosperiano": {"name": "Tecido Prosperiano", "kind": "material", "stackable": True, "color": "#c9a842", "rarity": "epico", "value": 600, "desc": "Tecido mágico tramado com luz do meio-dia da ilha. Só a Dona Bibi vende, e só pra quem ela achar digno."},
    "fio_dourado":     {"name": "Fio Dourado",     "kind": "material", "stackable": True, "color": "#e8c860", "rarity": "raro", "value": 250, "desc": "Fio batido em ouro de verdade. A agulha chora, o resultado canta."},
    "opulencia_capuz": {"name": "Capuz da Opulência Prosperiana", "kind": "armadura", "slot": "head", "stackable": False, "color": "#c9a842", "visual": "hood", "rarity": "lendario", "ac": 3, "spell_pow": 3, "value": 8000, "desc": "Peça do Set de Opulência Prosperiana. O tecido guarda calor de sol e frescor de sombra, conforme a cabeça precisar."},
    "opulencia_tunica": {"name": "Túnica da Opulência Prosperiana", "kind": "armadura", "slot": "body", "stackable": False, "color": "#c9a842", "visual": "robe", "rarity": "lendario", "ac": 6, "spell_pow": 4, "value": 15000, "desc": "Peça central do Set de Opulência Prosperiana. Dizem que a Bibi tece um segredo em cada bainha: nenhum dono descobriu o seu ainda."},
    "opulencia_calcas": {"name": "Calças da Opulência Prosperiana", "kind": "armadura", "slot": "legs", "stackable": False, "color": "#c9a842", "visual": "legs", "rarity": "lendario", "ac": 4, "spell_pow": 3, "value": 10000, "desc": "Peça do Set de Opulência Prosperiana. Não amassam, não sujam, não aceitam pressa."},
    "opulencia_botas": {"name": "Botas da Opulência Prosperiana", "kind": "armadura", "slot": "feet", "stackable": False, "color": "#c9a842", "visual": "boots", "rarity": "lendario", "ac": 3, "spell_pow": 3, "value": 8000, "desc": "Peça do Set de Opulência Prosperiana. Pisam em lama e saem limpas: a lama que se explique."},
    ...
    "bife_ancho": {"name": "Bife Ancho du Jacquard", "kind": "consumivel", "stackable": True, "color": "#a83838", "visual": "potion", "rarity": "raro", "heal": 60, "value": 350, "sell_value": 100, "desc": "O corte perfeito, o ponto perfeito, o preço perfeito (pra ele). Cura 60 de vida e um pouco do seu paladar antigo, que era uma vergonha."},
    "petit_gateau": {"name": "Petit Gâteau Celestial", "kind": "consumivel", "stackable": True, "color": "#6a4a34", "visual": "potion", "rarity": "raro", "heal": 30, "value": 180, "sell_value": 50, "desc": "Por fora firme, por dentro um pecado morno. Cura 30 de vida. O Chef chora quando sai perfeito. Sai sempre perfeito."},
    "queijo_angard": {"name": "Queijo Angard", "kind": "consumivel", "stackable": True, "color": "#e8d8a0", "visual": "potion", "rarity": "incomum", "heal": 20, "value": 45, "sell_value": 15, "desc": "Maturado na adega da mansão sob o olhar (com binóculo) de Madame Valliet. Cura 20."},
    "doce_da_baixa": {"name": "Doce da Capital (aham)", "kind": "consumivel", "stackable": True, "color": "#e0865a", "visual": "potion", "rarity": "comum", "heal": 12, "value": 18, "sell_value": 6, "desc": "Receita 'da capital'. O papel de embrulho tem cheiro da Baixa da Égua. Cura 12."},
    "cha_da_calma": {"name": "Chá da Calma", "kind": "consumivel", "stackable": True, "color": "#7a9a6a", "visual": "potion", "rarity": "comum", "heal": 10, "value": 15, "sell_value": 5, "desc": "Mexido 40 vezes no mesmo sentido pelo Sr. Camomilo. Cura 10. Tudo sob controle."},
    ...
    "bagre_abissal":   {"name": "Bagre Abissal",    "kind": "trofeu", "stackable": False, "color": "#4a5a7a", "rarity": "lendario", "value": 8000, "desc": "Sobe do fundo quando o trovão bate na água. Tem MUITOS dentes pra um bagre."},
