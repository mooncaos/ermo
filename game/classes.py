...
TRANSFORMS = {
    "druida": [
        {"id": "lobo",  "name": "Lobo",  "icon": "🐺",
         "desc": "Forma Selvagem do Lobo: caçador feroz e veloz. Dano MUITO maior (+3 dados e +8 fixo), +3 para acertar e +3 deslocamento, mas a pele fina baixa a guarda (-3 de armadura).",
         "bonus": {"dmg_dice": 3, "dmg_flat": 8, "atk": 3, "speed": 3, "ac": -3}},
        {"id": "urso",  "name": "Urso",  "icon": "🐻",
         "desc": "Forma Selvagem do Urso: muralha de músculo e couro. +12 de armadura e +25 de vida máxima, mas os golpes pesados são lentos (-2 de dano).",
         "bonus": {"ac": 12, "dmg_flat": -2, "hp": 25}},
        ...
        {"id": "mainecoon", "name": "Maine Coon", "icon": "🐈",
         "desc": "A forma abençoada por Pofnir: o grande gato Maine Coon, majestoso e equilibrado. +2 dados e +8 de dano, +5 para acertar, +6 de armadura, +25 de vida, +4 deslocamento e regenera 6 de vida por turno.",
         "requires": "blessing_pofnir",
         "bonus": {"ac": 6, "atk": 5, "dmg_dice": 2, "dmg_flat": 8, "speed": 4, "hp": 25}, "regen": 6},
    ],
    "ladino": [
