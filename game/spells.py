...
SPELLS = {
    ...
    "estilhacar":        {"name": "Estilhaçar", "level": 2, "kind": "save", "save": "CON", "save_effect": "half", "range": "ranged", "dmg": {"n": 3, "d": 8}, "dtype": "trovão",
    ...
    "esfera_flamejante": {"name": "Esfera Flamejante", "level": 2, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 2, "d": 6}, "dtype": "fogo",
                          "desc": "O alvo testa Destreza; 2d6 de fogo (metade no sucesso)."},
    "nuvem_adagas":      {"name": "Nuvem de Adagas", "level": 2, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 4, "d": 4}, "dtype": "cortante",
    ...
    # =========================== MAGIAS DE NIVEL 3 ===========================
    "bola_de_fogo":      {"name": "Bola de Fogo", "level": 3, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 8, "d": 6}, "dtype": "fogo",
                          "desc": "O alvo testa Destreza; 8d6 de fogo (metade no sucesso)."},
    "relampago":         {"name": "Relâmpago", "level": 3, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 8, "d": 6}, "dtype": "raio",
                          "desc": "O alvo testa Destreza; 8d6 de raio (metade no sucesso)."},
    "chamado_relampago": {"name": "Chamado do Relâmpago", "level": 3, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 3, "d": 10}, "dtype": "raio",
                          "desc": "O alvo testa Destreza; 3d10 de raio (metade no sucesso)."},
    "tempestade_gelo":   {"name": "Tempestade de Gelo", "level": 3, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 6, "d": 6}, "dtype": "gelo",
    ...
    # =========================== MAGIAS DE NIVEL 4 ===========================
    "esfera_vitriolica": {"name": "Esfera Vitriólica", "level": 4, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 10, "d": 4}, "dtype": "ácido",
    ...
    "invocar_relampagos": {"name": "Invocar Relâmpagos", "level": 4, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 4, "d": 10}, "dtype": "raio",
    ...
    # =========================== MAGIAS DE NIVEL 5 ===========================
    "cone_de_frio":      {"name": "Cone de Frio", "level": 5, "kind": "save", "save": "CON", "save_effect": "half", "range": "ranged", "dmg": {"n": 8, "d": 8}, "dtype": "gelo",
                          "desc": "O alvo testa Constituição; 8d8 de gelo (metade no sucesso)."},
    "nuvem_mortal":      {"name": "Nuvem Mortal", "level": 5, "kind": "control", "save": "CON", "save_effect": "half", "status": "poison", "turns": 3, "dot": {"n": 2, "d": 8}, "range": "ranged", "dmg": {"n": 5, "d": 8}, "dtype": "veneno",
    ...
    # =========================== MAGIAS DE NIVEL 6 ===========================
    "corrente_relampagos": {"name": "Corrente de Relâmpagos", "level": 6, "kind": "save", "save": "DES", "save_effect": "half", "range": "ranged", "dmg": {"n": 10, "d": 8}, "dtype": "raio",
