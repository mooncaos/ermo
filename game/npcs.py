...
ROSTER.append({"id": "npc:madre_aurora", "name": "Madre Aurora, Abadessa do Mosteiro",
    "look": {"skin": "#c9b090", "cloak": "#e8e0d0", "hat": "none", "hood": "up", "hair": "#d8d8d8", "staff": False},
    "map": "mosteiro_celeste", "home": (6, 3), "radius": 2, "wanders": True, "step_every": 3.6,
    "solid": True, "kind": "person",
    "greetings": ["Quarenta anos decorando os nomes dos Doze. Meus noviços erram TODOS. Eu respiro. Fundo.",
                  "O Simão chamou Facalan de 'Falacan' na oração. A vela APAGOU sozinha. Coincidência? Reze que sim.",
                  "Disciplina é amor com horário. Aqui se acorda com a aurora e se agradece por ela.",
                  "A Flor tem dom. O Simão tem fé. Juntos dão UM noviço completo. Os Doze sabem o que fazem."],
})
...
ROSTER.append({"id": "npc:jacques", "name": "Jacques, o Mordomo",
    "look": {"skin": "#c9b090", "cloak": "#2a2a34", "hat": "none", "hood": "down", "hair": "#d8d8d8", "staff": False},
    "map": "adega_angard", "home": (12, 3), "radius": 3, "wanders": True, "step_every": 3.4,
    "solid": True, "kind": "person",
    "greetings": ["Bonsoir. O senhor foi... anunciado? Non? *suspiro* Entre assim mesmo.",
                  "Trinta anos servindo os Angard. O relógio da casa atrasa; eu, jamais.",
                  "Madame recebe às quintas. Monsieur recebe sempre — desde que traga sede."],
})
ROSTER.append({"id": "npc:henri", "name": "Henri, o Sommelier",
    "look": {"skin": "#c9a06a", "cloak": "#5a2434", "hat": "none", "hood": "down", "hair": "#3a2a1a", "staff": False},
    "map": "adega_angard", "home": (18, 12), "radius": 2, "wanders": True, "step_every": 3.0,
    "solid": True, "kind": "person",
    "greetings": ["Este barril? 12 anos. Aquele? 30. Aquele ali... non, aquele é vinagre. Erros acontecem.",
                  "O Arcebispo chama de 'litúrgico'. Monsieur pisca pra mim. Eu só sirvo.",
                  "Um vinho por dia. Dois em dia de festa. Três... só em naufrágio."],
})
...
ROSTER.append({"id": "npc:pierre", "name": "Pierre, o Jardineiro",
    "look": {"skin": "#a8845c", "cloak": "#4a6a3a", "hat": "none", "hood": "down", "hair": "#6a5a3a", "staff": False},
    "map": "adega_angard", "home": (5, 11), "radius": 4, "wanders": True, "step_every": 3.2,
    "solid": True, "kind": "person",
    "greetings": ["As videiras lá fora? Minhas filhas. As rosas da Lady Diana? Minhas rivais.",
                  "Monsieur fala com as uvas em francês. Elas preferem. Sotaque adoça.",
                  "Terra boa não mente. Gente, às vezes. Por isso almoço com a terra."],
})
