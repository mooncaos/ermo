...
ROSTER.extend([
    ...
    },
    {
        ...
        "map": "ermo", "home": (35, 26), "radius": 2, "wanders": True,
    ...
    },
    {
        ...
        "look": {"skin": "#8a5a38", "cloak": "#7a5030", "hood": "down",
                 "hat": "none", "hair": "#3a3028", "staff": False},
        "sex": "F",
        "map": "ermo", "home": (21, 28), "radius": 2, "wanders": True,
        "step_every": 1.7, "solid": True, "kind": "person",
    ...
    },
    {
        ...
        "look": {"skin": "#7a5436", "cloak": "#8a6a44", "hood": "down",
                 "hat": "none", "hair": "#3a3028", "staff": False},
        "map": "ermo", "home": (59, 50), "radius": 2, "wanders": True,
        "step_every": 1.7, "solid": True, "kind": "person",
    ...
    },
    {
        ...
        "look": {"skin": "#9a6a48", "cloak": "#4a6a4a", "hood": "down",
                 "hat": "none", "hair": "#3a3028", "staff": False},
        "map": "ermo", "home": (9, 70), "radius": 2, "wanders": True,
        "step_every": 1.7, "solid": True, "kind": "person",
    ...
    },
    {
        ...
        "look": {"skin": "#b08a68", "cloak": "#8a3050", "hood": "down",
                 "hat": "none", "hair": "#3a3028", "staff": False},
        "sex": "F",
        "map": "ermo", "home": (35, 82), "radius": 2, "wanders": True,
        "step_every": 1.7, "solid": True, "kind": "person",
    ...
    },
    {
        ...
        "look": {"skin": "#7a5436", "cloak": "#d060c0", "hood": "down",
                 "hat": "none", "hair": "#3a3028", "staff": False},
        "sex": "F",
        "map": "ermo", "home": (11, 84), "radius": 2, "wanders": True,
        "step_every": 1.7, "solid": True, "kind": "person",
    ...
    },
    {
        ...
        "look": {"skin": "#8a5a38", "cloak": "#a86a40", "hood": "down",
                 "hat": "none", "hair": "#3a3028", "staff": False},
        "map": "ermo", "home": (53, 88), "radius": 2, "wanders": True,
        "step_every": 1.7, "solid": True, "kind": "person",
