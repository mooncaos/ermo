...
ROSTER.append({
    ...
    "greetings": ['O Bruno trocou pão por peixe comigo. Melhor negócio da ilha. Não conta pro Otto.',
...
ROSTER.append({
    ...
    "step_every": 2.8, "solid": True, "kind": "person",
    "greetings": ['A Suma Clara elogiou meu pão. EU SEI que o dela é melhor. Santa E diplomata.',
...
ROSTER.append({
    ...
    "greetings": ['O menino Caio atravessou a praça em oito segundos. Recorde. Multei. Ele emoldurou a multa.',
...
ROSTER.append({
    ...
    "step_every": 2.8, "solid": True, "kind": "person",
    "greetings": ["O Lorde Fadogan mói minha colheita de graça 'entre vizinhos'. Nobreza é isso: renda alheia.",
...
ROSTER.append({
    ...
    "step_every": 3.0, "solid": True, "kind": "person",
    "greetings": ['A Suma Iara assobia e o lobo VAI EMBORA. Eu assobio e as ovelhas RIEM. Cada um com seu dom.',
...
ROSTER.append({"id": "npc:maria_valmont", "name": "Tenente Maria Valmont",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Valmont, sim. A ovelha marmota da família virou soldado. Orgulho de ninguém, menos meu.', 'O Lorde Comandante confia em mim. É só o que me importa. Que a corte comente.', 'Treino os novatos na base do grito e do exemplo. Funciona. Dói, mas funciona.', 'Minha prima Isolda serve chá. Eu sirvo justiça. Adivinha qual Valmont dorme melhor.'],
})
ROSTER.append({"id": "npc:mago_var", "name": "Arquimago-Comandante Varo",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Sou a magia da Guarda e a espada do Conclave. Dois postos, uma só mente.', 'De dia estudo com o Heron; de noite guardo Prospera. Magos não descansam, otimizam.', 'Um exército sem mago é um punho sem polegar. Eu sou o polegar.'],
})
ROSTER.append({"id": "npc:clerigo_bat", "name": "Clériga de Batalha Solenne",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Curo o que a espada abre e abençoo o que a espada fecha. Valiria me guia.', 'Sirvo no Templo E no Quartel. A fé protege a alma; eu protejo o corpo que a carrega.', 'Antes da batalha, a oração. Depois da batalha, a bandagem. Eu faço as duas.'],
})
ROSTER.append({"id": "npc:mordomo_gil", "name": "Gil, o Mordomo (sobrinho do Jacques)",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Meu tio Jacques serve os Angard. Eu sirvo a legião. Suspiro igual, fardo maior.', 'Cem soldados pra alimentar, vestir e ORGANIZAR. Tio Jacques só tem dez nobres. Amador.'],
})
ROSTER.append({"id": "npc:mordomo_val", "name": "Valdo, o Mordomo (filho do Seu Juvenal)",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Meu pai Juvenal tem o sobrado da Baixa. Eu tenho o quartel inteiro pra polir.', 'O Gil cuida dos oficiais, eu da tropa. Dividir pra reinar. Ou pra sobreviver.'],
})
ROSTER.append({"id": "npc:cozinheiro_lau", "name": "Lau, o Cozinheiro (filho da Nega Luzia)",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Minha mãe Luzia faz doce pra Baixa. Eu faço rango pra 72 soldados famintos. RESPEITO.', 'Segredo do meu ensopado? Herança da mãe: capricho e uma pitada de deboche.', 'Soldado bem comido não reclama. Soldado com fome... aí a Tenente que resolve.'],
})
ROSTER.append({"id": "npc:chefe_armas", "name": "Ferro, o Chefe de Armas (irmão do Bito)",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Meu irmão Bito ferra égua com ouro. Eu afio espada com ódio. Ofício de família.', 'Cada lâmina desta armaria passou pela minha pedra. Cada uma. Duas vezes.', 'Arma cega mata o dono. Por isso aqui NENHUMA é cega. Nem os soldados, espero.'],
})
...
ROSTER.append({"id": "npc:otavio_valmont", "name": "Lorde Otavio Valmont",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Valmont. V-A-L-M-O-N-T. Uma casa antiga. Quase tão antiga quanto... enfim. Antiga.', 'Os Prosperi têm o farol. Nós temos... perspectivas. E um leilão LUCRATIVO.', 'Meu filho Fagnin bate o martelo como um rei. Um rei de leilões. Conta.'],
})
ROSTER.append({"id": "npc:isolda_valmont", "name": "Lady Isolda Valmont",
    ...
    "solid": True, "kind": "person",
    "greetings": ['A Rainha Valesca serve o chá às cinco. O MEU é às quatro e meia. Pioneirismo.', 'Beatriz, postura! ...perdão, força do hábito. Postura também pra você.', 'Dizem que inveja é feio. Feio é o brasão dos outros ser maior.'],
})
ROSTER.append({"id": "npc:beatriz_valmont", "name": "Beatriz Valmont",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Mamãe quer que eu case com um Prosperi. Só tem UM solteiro. E ele mora num farol.', 'Eu queria era tocar violão. Nobre pode? Vou perguntar pro Mestre Corda.', 'A filha do alfaiate é minha melhor amiga. Em segredo. Nobreza cansa.'],
})
ROSTER.append({"id": "npc:prudencio", "name": "Embaixador Prudêncio",
    ...
    "solid": True, "kind": "person",
    "greetings": ['As Terras do Ermo saúdam Prosperina. Protocolo 7, parágrafo 2. Prossiga.', 'Diplomacia é a arte de bocejar por dentro sorrindo por fora.', 'O porão? Depósito. De... assuntos consulares. Não desça. É PROTOCOLO.'],
})
ROSTER.append({"id": "npc:sr_protocolo", "name": "Sr. Protocolo, o Adido",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Selou? Carimbou? Datou? Rubricou? Então NÃO EXISTE. Volte com o formulário 9-B.', 'Sou pago para dizer não com elegância. Não. Viu? Elegante.'],
})
...
ROSTER.append({"id": "npc:fagnin_valmont", "name": "Lord Fagnin Valmont, o Leiloeiro",
    ...
    "solid": True, "kind": "person",
    "greetings": ['DOU-LHE UMA! DOU-LHE DUAS! ...ah, cliente. Perdão. O martelo fica ansioso.', 'Lord Fagnin Valmont. Bato o martelo, subo o preço, durmo tranquilo.', 'O LOTE DO DIA muda toda alvorada. Raro, único, CARO. Como eu.', 'Papai queria que eu fosse general. Eu conquisto por LANCES.'],
})
ROSTER.append({"id": "npc:srta_lance", "name": "Srta. Lance, a Assistente",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Eu registro os lances, os lotes e os chiliques do Lord. Nessa ordem de volume.', "O martelo dele custou mais que meu salário anual. Ele chama o martelo de 'Justino'."],
})
...
ROSTER.append({"id": "npc:pedreiro_batista", "name": "Mestre Batista, o Pedreiro",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Metade de Prospera tem tijolo meu. A outra metade vai ter. Orçamento grátis.'],
})
ROSTER.append({"id": "npc:professor_anselmo", "name": "Professor Anselmo",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Ensino as crianças da capital. O Caio de Vilalbina vem uma vez por semana. Correndo.'],
})
ROSTER.append({"id": "npc:dede_costureira", "name": "Dedé, a costureira",
    "look": {"skin": "#c9a06a", "cloak": "#6a5a4a", "hat": "none", "hood": "down", "hair": "#4a3a2a", "staff": False},
    "map": "prospera", "home": (6, 24), "radius": 4, "wanders": True, "step_every": 2.8,
    "solid": True, "kind": "person",
    "greetings": ['Eu começo a frase e a Didi...'],
})
...
ROSTER.append({"id": "npc:guarda_trovao", "name": "Seu Trovão, guarda aposentado",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Trinta anos de ronda. Hoje patrulho o neto. Missão mais perigosa.'],
})
ROSTER.append({"id": "npc:dona_firmina", "name": "Dona Firmina, a Parteira",
    ...
    "solid": True, "kind": "person",
    "greetings": ['Fiz metade dessa capital nascer. A OUTRA metade nasceu com pressa antes de eu chegar.', 'A Lady Diana? Puxou o choro forte da mãe. Isso eu posso contar. O resto, segredo de parto.'],
})
ROSTER.append({"id": "npc:moco_elviro", "name": "Moço Elviro, o Poeta",
    "look": {"skin": "#c9a06a", "cloak": "#6a5a4a", "hat": "none", "hood": "down", "hair": "#4a3a2a", "staff": False},
    "map": "prospera", "home": (52, 48), "radius": 4, "wanders": True, "step_every": 2.8,
    "solid": True, "kind": "person",
    "greetings": ['Pago o aluguel em sonetos. O senhorio aceita. Ele chora no verso nove, TODA vez.', "Prospera rima com espera, quimera e... 'dinheiro não tem rima', diz meu estômago."],
})
...
ROSTER.append({"id": "npc:mestre_fanfarrao", "name": "Mestre Fanfarrão, o Cerimonialista",
    ...
    "solid": True, "kind": "person",
    "greetings": ["BEM-VINDOS AO FEIRÃO DE SÃO CELESTE! Hoje não tem evento. Mas o ANÚNCIO foi lindo, não foi?",
...
ROSTER.append({"id": "npc:seu_juvenal", "name": "Seu Juvenal do Sobrado",
    ...
    "solid": True, "kind": "person",
    "greetings": ["Aqui é a Baixa, meu amigo. Quebrada RAIZ. Meu sobrado só tem mármore no primeiro E no segundo andar.",
...
ROSTER.append({"id": "npc:dona_rita", "name": "Dona Rita das Éguas",
    ...
    "solid": True, "kind": "person",
    "greetings": ["O bairro tem meu nome. Quer dizer, das minhas éguas. Mesma coisa.",
...
ROSTER.append({"id": "npc:bito_ferradura", "name": "Bito Ferradura",
    ...
    "solid": True, "kind": "person",
    "greetings": ["Ferro casco de égua de ouro. Literalmente: a Dona Rita pediu ferradura BANHADA.",
...
ROSTER.append({"id": "npc:nega_luzia", "name": "Nega Luzia, a Doceira da Baixa",
    ...
    "solid": True, "kind": "person",
    "greetings": ["Doce da Baixa é doce de verdade: açúcar, capricho e uma pitada de deboche.",
...
ROSTER.append({"id": "npc:coelho_fofo", "name": "Fofo",
    ...
    "greetings": ["*mexe o nariz em altíssima frequência*", "*congela. te encara. some.*"],
})
ROSTER.append({"id": "npc:coelha_tufo", "name": "Tufo",
    ...
    "solid": False, "kind": "rabbit",
    "greetings": ["*rouba um trevo e foge com orgulho*", "*a Suma Sorte já tentou apostar corrida com ela. Perdeu.*"],
})
ROSTER.append({"id": "npc:cao_bilau", "name": "Bilau",
    ...
    "greetings": ["*abana o rabo com o corpo inteiro*", "Au! *te acompanha por três passos e desiste*",
...
ROSTER.append({"id": "npc:galinha_cocota", "name": "Cocota",
    ...
    "greetings": ["Có? *te olha de lado, julgando*", "Có có CÓ! *anúncio importante sobre nada*"],
})
ROSTER.append({"id": "npc:galinha_nini", "name": "Nini",
    ...
    "solid": False, "kind": "chicken",
    "greetings": ["*cisca com a dedicação de quem paga boleto*", "Có. *é tudo que você merece hoje*"],
})
...
ROSTER.append({"id": "npc:margot", "name": "Margot, a Copeira",
    ...
    "solid": True, "kind": "person",
    "greetings": ["Doze lugares na mesa, dois moradores. Madame diz que esperança também janta.",
...
ROSTER.append({"id": "npc:amelie", "name": "Amélie, a Camareira",
    ...
    "solid": True, "kind": "person",
    "greetings": ["Madame tem 40 vestidos. Usa 3. Os outros 37 são 'patrimônio emocional'.",
...
ROSTER.append({"id": "npc:luc", "name": "Luc, o Lacaio",
    ...
    "solid": True, "kind": "person",
    "greetings": ["Recado pra cidade? Eu levo. Recado pra Madame? Eu... reformulo primeiro.",
