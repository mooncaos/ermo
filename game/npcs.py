...
ROSTER.append({"id": "npc:egua_relampago", "name": "Relâmpago",
    "look": {"skin": "#8a5a3a", "cloak": "#6a4a2a", "hat": "none", "hood": "down", "hair": "#3a2a1a", "staff": False},
    "map": "baixa_da_egua", "home": (20, 12), "radius": 2, "wanders": True, "step_every": 2.0,
    "solid": True, "kind": "horse",
    "greetings": ["*relincha com espírito competitivo*", "*bate a pata: quer pista*", "*te mede: você parece lento*"],
})
ROSTER.append({"id": "npc:egua_cocada", "name": "Cocada",
    "look": {"skin": "#8a5a3a", "cloak": "#6a4a2a", "hat": "none", "hood": "down", "hair": "#3a2a1a", "staff": False},
    "map": "baixa_da_egua", "home": (22, 12), "radius": 2, "wanders": True, "step_every": 2.0,
    "solid": True, "kind": "horse",
    "greetings": ["*relincha com espírito competitivo*", "*bate a pata: quer pista*", "*te mede: você parece lento*"],
})
ROSTER.append({"id": "npc:egua_valente", "name": "Valente",
    "look": {"skin": "#8a5a3a", "cloak": "#6a4a2a", "hat": "none", "hood": "down", "hair": "#3a2a1a", "staff": False},
    "map": "baixa_da_egua", "home": (24, 12), "radius": 2, "wanders": True, "step_every": 2.0,
    "solid": True, "kind": "horse",
    "greetings": ["*relincha com espírito competitivo*", "*bate a pata: quer pista*", "*te mede: você parece lento*"],
})
ROSTER.append({"id": "npc:egua_estrela", "name": "Estrela",
    "look": {"skin": "#8a5a3a", "cloak": "#6a4a2a", "hat": "none", "hood": "down", "hair": "#3a2a1a", "staff": False},
    "map": "baixa_da_egua", "home": (26, 12), "radius": 2, "wanders": True, "step_every": 2.0,
    "solid": True, "kind": "horse",
    "greetings": ["*relincha com espírito competitivo*", "*bate a pata: quer pista*", "*te mede: você parece lento*"],
})
ROSTER.append({"id": "npc:gato_branco", "name": "O Gato Branco e Grande",
    "look": {"skin": "#f5f5f0", "cloak": "#f5f5f0", "hat": "none", "hood": "down", "hair": "#f5f5f0", "staff": False},
    "map": "limbo_pofnir", "home": (5, 5), "radius": 4, "wanders": True, "step_every": 1.4,
    "solid": False, "kind": "cat",
    "greetings": ["...", "*ele te olha como quem já te conheceu inteiro*",
                  "*o mundo parece conter a respiração*",
                  "*você sente que deveria se desculpar por algo. Não sabe o quê.*",
                  "*miado? Não. Foi outra coisa. Melhor não pensar nisso.*"],
})
...
ROSTER.append({
    ...
    "step_every": 2.4, "solid": True, "kind": "person",
    "greetings": ['Sou Diana Prosperi. Primeira do nome, primeira na linha, primeira a acordar. Memorize a ordem.', 'Prospera vai brilhar mais do que Valdarkram JAMAIS brilhou. Anote.', 'Dizem que meu olhar pesa. Ótimo. Coroas pesam; olhares que as merecem também.', 'Meu irmão escolheu o farol. Eu escolhi a coroa. Cada Prosperi com sua torre — a minha tem trono.', 'A corte sussurra sobre mim. Que sussurrem. Sussurro é o volume de quem não ousa falar alto.', 'Cavalgo sozinha ao amanhecer. A cidade acordando é o único conselheiro que não me interrompe.', 'Minhas rosas? Impossíveis. Floresceram mesmo assim. Aprenda com elas.', 'Serei rainha. Não porque pedi — porque nasci. E eu NÃO serei questionada.', 'O mar me conhece desde o berço. Quando eu reinar, ele será meu primeiro súdito. Ele já concordou.', 'Doçura eu guardo pros leais. Pra quem duvida, guardo a memória. Sou EXCELENTE de memória.'],
})
ROSTER.append({
